        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Media Server</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <input  tbl="media_servers" type="button" class="btn btn-primary button" style="float: right" id="btnSave" is_single=""  value="Save"/>
                </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-footer">
                  <?=loadDataList($tblName = 'media_servers',$fileds = 'SERVER_IMAGE,SERVER_NAME,SERVER_URL,ORDER_SL',$canEdit=1,$canDelete=1,$con,$where="");?>
                </div>
              </form>
            </div>
          </div>
